...
namespace WebApplication1.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/SumData", ReplyAction="http://tempuri.org/IService1/SumDataResponse")]
        int SumData(int x, int y);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/SumData", ReplyAction="http://tempuri.org/IService1/SumDataResponse")]
        System.Threading.Tasks.Task<int> SumDataAsync(int x, int y);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<WebApplication1.ServiceReference1.IService1>, WebApplication1.ServiceReference1.IService1 {
        ...
        public int SumData(int x, int y) {
            return base.Channel.SumData(x, y);
        }
        
        public System.Threading.Tasks.Task<int> SumDataAsync(int x, int y) {
            return base.Channel.SumDataAsync(x, y);
        }
    }
}
